...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-93479dac');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-93479dac');}
...
var brandEl=document.querySelector('.rl-brand-93479dac');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
